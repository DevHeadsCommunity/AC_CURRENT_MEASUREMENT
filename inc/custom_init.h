...
#define GSMPWRKEYON GPIOB->ODR |= (1 << 9)
#define GSMPWRKEYOFF GPIOB->ODR &= ~(1 << 9)
#define MIN_VOLTAGE_THRESHOLD 65
#define MAX_VOLTAGE_THRESHOLD 150
#define SEC_PER_HOUR 3600
extern volatile uint16_t value1;
...
extern volatile uint8_t counter_check;
